...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('brewlog_comment', (
            ...
            ('hideemail', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('brewlog', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table('brewlog_comment')
    ...
    models = {
        ...
        'brewlog.comment': {
            ...
            'hideemail': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'brewlog.extract': {
