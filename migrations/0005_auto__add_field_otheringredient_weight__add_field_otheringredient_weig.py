...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OtherIngredient.weight'
        db.add_column('brewlog_otheringredient', 'weight',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'OtherIngredient.weight_unit'
        db.add_column('brewlog_otheringredient', 'weight_unit',
                      self.gf('django.db.models.fields.CharField')(default='oz', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OtherIngredient.weight'
        db.delete_column('brewlog_otheringredient', 'weight')

        # Deleting field 'OtherIngredient.weight_unit'
        db.delete_column('brewlog_otheringredient', 'weight_unit')
