...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrewDay.brewer'
        db.add_column('brewlog_brewday', 'brewer',
                      self.gf('django.db.models.fields.CharField')(default='Jason', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrewDay.brewer'
        db.delete_column('brewlog_brewday', 'brewer')
    ...
    models = {
        ...
        'brewlog.brewday': {
            ...
            'brewer': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
