...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SteepingGrain.weight_unit'
        db.add_column('brewlog_steepinggrain', 'weight_unit',
                      self.gf('django.db.models.fields.CharField')(default='lb', max_length=8),
                      keep_default=False)

        # Adding field 'Hop.weight_unit'
        db.add_column('brewlog_hop', 'weight_unit',
                      self.gf('django.db.models.fields.CharField')(default='lb', max_length=8),
                      keep_default=False)

        # Adding field 'Extract.weight_unit'
        db.add_column('brewlog_extract', 'weight_unit',
                      self.gf('django.db.models.fields.CharField')(default='oz', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SteepingGrain.weight_unit'
        db.delete_column('brewlog_steepinggrain', 'weight_unit')

        # Deleting field 'Hop.weight_unit'
        db.delete_column('brewlog_hop', 'weight_unit')

        # Deleting field 'Extract.weight_unit'
        db.delete_column('brewlog_extract', 'weight_unit')
